...
Previously this file was an exact duplicate of the handlers version, which caused
...
This file is kept as a stub so any existing imports of
`app.services.topic_router` do not break, but it registers nothing.
